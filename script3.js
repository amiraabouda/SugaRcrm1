function calendar() {
  ...
  var tbhtxt = document.createTextNode(
    monthNames[today.getMonth() + 1] + "." + year
  );
...
typeof window.addEventListener == "undefined"
  ? window.attachEvent("onload", calendar)
  : addEventListener("load", calendar, false);

var nomtext = document.getElementById("nomtext");

var nominp = document.getElementById("nominp");
var emailinp = document.getElementById("emailinp");

var emailtext = document.getElementById("emailtext");

nominp.addEventListener("change", function () {
  nomtext.innerText = nominp.value;
});

emailinp.addEventListener("change", function () {
  emailtext.innerText = emailinp.value;
});
